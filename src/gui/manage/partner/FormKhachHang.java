...
public class FormKhachHang extends JPanel {
    ...
    private JPanel createTablePanel() {
        ...
        TextFilterator<KhachHang> textFilterator = new TextFilterator<KhachHang>() {
            @Override
            public void getFilterStrings(List<String> baseList, KhachHang element) {
                if (element.getMaKH()!= null) {
                    baseList.add(element.getMaKH());
                }
                if (element.getTenKH() != null) {
                    baseList.add(element.getTenKH());
                }
                if (element.getSdt() != null) {
                    baseList.add(element.getSdt());
                }
                if (element.getDiaChi() != null) {
                    baseList.add(element.getDiaChi());
                }
            }
        };
            ...
            table.putClientProperty(FlatClientProperties.STYLE,
                    "rowHeight:30; showHorizontalLines:true");
            table.getTableHeader()
                    .putClientProperty(FlatClientProperties.STYLE, "height:35; font:bold");
    ...
    private class KhachHangTableFormat implements ca.odell.glazedlists.gui.TableFormat<KhachHang> {
        ...
        public Object getColumnValue(KhachHang kh, int column) {
            switch (column) {
                ...
                case 4:
                    return kh.getNgaySinh() != null ? kh.getNgaySinh().format(formatter) : "";
                case 5:
                    return kh.getDiaChi() != null ? kh.getDiaChi() : "";
                case 6:
